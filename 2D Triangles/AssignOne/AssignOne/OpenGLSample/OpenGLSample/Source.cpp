...
namespace
{
    const char* const WINDOW_TITLE = "Robert Chandler Assingment One"; // Macro for window title
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] =
    {
        ...
        // index 2
        0.0f, -0.5f, 0.0f,      // bottom-center of the screen
        ...
        // index 4
        0.5f, -0.5f, 0.0f,      // bottom-right of the screen
        0.0f, 1.0f, 0.0f, 1.0f  // green
    };
